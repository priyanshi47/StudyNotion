...
const Terms = () => {
  return (
    <div>
<div className=' bg-white flex-col p-4 gap-3 '>
<h1 className='text-blue-500 font-bold text-3xl'>Terms Of Use</h1>
These Terms of Use set out the terms and conditions for use of this StudyNotion Website and any content, Public Forums, or services offered on or through the Website and/or through any mobile application(s).<br></br>

These Terms of Use apply to end users of the Website (referred to as “Learners”, “You”, “Your”). These Terms of Use, including the Privacy Policy and any other terms and conditions published on the Platform or communicated to you from time to time (collectively referred to as the “Agreement”), define the relationship and responsibilities between You and Creator (as defined herein) in using the Platform. Your access to the Platform is subject to Your acceptance of this Agreement. Hence, please take Your time to read this Agreement.<br></br>

When we speak of “Creator”, ‘we’, ‘us’, and ‘our’, we collectively mean StudyNotion being the creator of this Platform and the content/materials/services contained therein.<br></br>
...
If You disagree with any part of this Agreement or do not wish to be bound by the same, then please do not use the Platform in any manner.<br></br>

<span className='text-xl text-blue-300 font-bold'>Access and Registration:</span>
...
<span className='text-xl text-blue-300 font-bold'>License to Use:</span>
...
transfer the any material made available on the Platform to another person or 'mirror' the same on any other server.
For the purpose of this Agreement, “Creator Content” shall mean and include any audio files, video files, audio-visual files, images, text materials (including .doc, .docx, and .pdfs) (other than the Content) uploaded or otherwise published on the Platform by the Creator to be accessed by You, including, but not limited to any such content/material posted by the Creator in any Public Forum (defined below).<br></br>
...
<span className='text-xl text-blue-300 font-bold'>Spam:</span>
 Posting untargeted, unwanted and repetitive content, comments or messages with an intention to spam a Public Forum or otherwise the Platform and to drive traffic from the Platform to other third-party sites is in direct violation of this Agreement. Posting links to external websites with malware and other prohibited sites is not allowed.<br></br>
<span className='text-xl text-blue-300 font-bold'>Scams:</span>
 Any content uploaded or posted in order to trick others for their own financial gain is not allowed and we do not tolerate any practices of extortion or blackmail, either<br></br>
<span className='text-xl text-blue-300 font-bold'>Privacy violation:</span>
 Kindly refer to our Privacy Policy to know how to protect Your privacy and respect the privacy of other Users.<br></br>
<span className='text-xl text-blue-300 font-bold'>Impersonation:</span>
...
<span className='text-xl text-blue-300 font-bold'>Unauthorized Access or Disabling of Platform:</span>
...
If any violation of the above rules of conduct comes to our notice, then, we reserve the right to refuse Your access to the Platform, terminate accounts or remove such violating content at any time without notice to You.<br></br>


<span className='text-xl text-blue-300 font-bold'>Intellectual Property:</span>
...
<span className='text-xl text-blue-300 font-bold'>Waiver:</span> If You breach these conditions and we take no action, we will still be entitled to use our rights and remedies in any other situation where You breach these conditions.<br></br>

 <span className='text-xl text-blue-300 font-bold'>Severability:</span>If any provision of this Agreement will be adjudged by any court of competent jurisdiction to be unenforceable or invalid, that provision will be limited to the minimum extent necessary so that this Agreement will otherwise remain in effect.<br></br>
<span className='text-xl text-blue-300 font-bold'>Events beyond our reasonable control:</span> We will not be held responsible for any delay or failure to comply with our obligations under these conditions if the delay or failure arises from any cause which is beyond our reasonable control. This condition does not affect Your statutory rights.
